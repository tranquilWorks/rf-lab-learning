# Repository instructions — RF and Microwave Measurement

## Product purpose

This repository is the **RF and Microwave Measurement** interactive MATLAB learning system, not a collection of disconnected demos. Teach concepts through controlled experiments, notebook-style sections, plots, parameter levers, deliberately broken cases, and concise dialogue.
...
- Product: `rf-lab-learning`; delivery profile: `product-data`.
