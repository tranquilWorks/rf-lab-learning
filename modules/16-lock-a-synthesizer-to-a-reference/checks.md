# P16 checks: Lock a Synthesizer to a Reference
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you lock a Synthesizer to a Reference?” without relying on MATLAB syntax.
