# P11 checks: Create Intermodulation Products
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you create Intermodulation Products?” without relying on MATLAB syntax.
