# P13 checks: Mix RF to an Intermediate Frequency
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you mix RF to an Intermediate Frequency?” without relying on MATLAB syntax.
