# P03 checks: Match a Load to a Source
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you match a Load to a Source?” without relying on MATLAB syntax.
