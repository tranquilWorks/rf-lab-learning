# P21 checks: Use Couplers and Pads Intentionally
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you use Couplers and Pads Intentionally?” without relying on MATLAB syntax.
