# P23 walkthrough: Trace an SDR RF Chain

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you trace an SDR RF Chain?
...
This sequence is a build contract, not evidence that P23 is implemented.
